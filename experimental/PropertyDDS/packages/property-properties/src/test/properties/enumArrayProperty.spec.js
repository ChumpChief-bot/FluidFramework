...
describe("EnumArrayProperty", () => {
	...
	it("Should be able to set a value using an Enum number", () => {
		const property = PropertyFactory.create("autodesk.enum:enums-1.0.0");
	...
	it("Should throw on setting invalid Enum number", () => {
		const property = PropertyFactory.create("autodesk.enum:enums-1.0.0");
		expect(() => {
	...
	it("Should be able to set a value using an Enum string", () => {
		const property = PropertyFactory.create("autodesk.enum:enums-1.0.0");
	...
	it("Should throw on setting invalid Enum string", () => {
		const property = PropertyFactory.create("autodesk.enum:enums-1.0.0");
		expect(() => {
	...
	it("Should be able to insert a value using an Enum number", () => {
		const property = PropertyFactory.create("autodesk.enum:enums-1.0.0");
	...
	it("Should throw on inserting invalid Enum number", () => {
		const property = PropertyFactory.create("autodesk.enum:enums-1.0.0");
		expect(() => {
	...
	it("Should be able to insert a value using an Enum string", () => {
		const property = PropertyFactory.create("autodesk.enum:enums-1.0.0");
	...
	it("Should throw on inserting invalid Enum string", () => {
		const property = PropertyFactory.create("autodesk.enum:enums-1.0.0");
		expect(() => {
	...
	it("Should be able to overide default values on creation with initialValues", () => {
		const initialValues = { enumArray: [3, 2, 3] };
		const property = PropertyFactory.create("autodesk.enum:enums-1.0.0", null, initialValues);
	...
	it(".getValidEnumList should return expected enum list", () => {
		const property = PropertyFactory.create("autodesk.enum:enums-1.0.0");
		const enumList = property.get("enumArray").getValidEnumList();
